<template>
<!-- @click="$emit('onCalcButtonClick', label)" - quando o clique for disparado a expressao $emit vai chamar um outro evento onCalcButtonClick e esse evento vai receber como parametro o label -->
